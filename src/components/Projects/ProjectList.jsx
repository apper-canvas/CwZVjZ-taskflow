...
import { Edit, Trash2, Plus, Filter, Search, ArrowUp, ArrowDown, Users } from 'lucide-react';
...
function ProjectList() {
  ...
  const fetchProjects = async () => {
    try {
      setLoading(true);
      const response = await projectService.getProjects(filters, page, limit, sortField, sortDirection);
  ...
  const handleSearch = (e) => {
    ...
    // Filter by name using contains operator
          ...
          <div className="relative">
            ...
            {filterOpen && (
              <div className="absolute right-0 mt-2 w-72 bg-white rounded-md shadow-lg z-10 border border-gray-200">
                <div className="p-4">
                  <h3 className="text-lg font-medium mb-3">Filter Projects</h3>
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  Showing <span className="font-medium">{projects.length > 0 ? page * limit + 1 : 0}</span> to{' '}
